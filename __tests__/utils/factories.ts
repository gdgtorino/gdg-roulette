...
export function createMockLotteryEntry(overrides: Partial<MockLotteryEntry> = {}): MockLotteryEntry {
  const timestamp = new Date()
...
export function createMockLotteries(count: number, overrides: Partial<MockLottery> = {}): MockLottery[] {
  return Array.from({ length: count }, () => createMockLottery(overrides))
}

export function createMockLotteryEntries(count: number, overrides: Partial<MockLotteryEntry> = {}): MockLotteryEntry[] {
  return Array.from({ length: count }, () => createMockLotteryEntry(overrides))
}

// Complex scenario factories
export function createMockEventWithLotteries(lotteryCount: number = 2): { event: MockEvent; lotteries: MockLottery[] } {
...
export function createMockLotteryWithEntries(entryCount: number = 5): { lottery: MockLottery; entries: MockLotteryEntry[] } {
