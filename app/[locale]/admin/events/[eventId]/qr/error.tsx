      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm border-b dark:border-gray-700">
        <div className="mx-auto max-w-4xl px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Event QR Code</h1>
              <p className="text-gray-600 dark:text-gray-400">Error loading event</p>
            </div>
            <HeaderControls />
          </div>
        </div>
        ...
        <Card className="dark:bg-gray-800 dark:border-gray-700">
          <CardHeader className="text-center">
            ...
            <CardDescription className="dark:text-gray-300">
              There was an error loading the event QR code page. Please try again.
            </CardDescription>
          </CardHeader>
